using Dimah.Core.Application.Enums;
...
namespace Dimah.InfraStructure.Contexts
{
    public static class DefaultData
    {
        ...
        {
            ProjectType[] arrData = new ProjectType[2];
            arrData[0] = new ProjectType { Id = 1, NameAr = "مشروع خيري", NameEn = "Project Charity", IsActive = false, CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            arrData[1] = new ProjectType { Id = 2, NameAr = "كفالة يتيم", NameEn = "Orphan", IsActive = true, CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            return arrData;
        }
        ...
        public static Role[] Roles()
        {
            ...
            arrData[2] = new Role { Id = 3, NameAr = "صلاحيات الاعدادات", NameEn = "Setting Permission", IsActive = true, CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            arrData[3] = new Role { Id = 4, NameAr = "صلاحيات المستخدمين", NameEn = "Users Permission", IsActive = true, CreatedBy = 1, CreatedDate = new DateTime(2022, 10, 1) };
            return arrData;
        }
